...
export const experiences = [
  ...
  },
  {
    ...
    description: [
      ...
      'Outra linguagem em que tive a oportunidade de me aprofundar foi o Python. Essa linguagem versátil e de fácil compreensão me permitiu desenvolver soluções eficazes para diferentes desafios, desde análise de dados até a criação de sistemas de automação. Através do Python, expandi minha capacidade de resolver problemas e criar soluções eficientes.',
